...
export async function POST_registerMessageToken(payload: any) {
...
// TODO
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export async function POST_registerMessageTokenRetry(payload: any) {
...
// TODO
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export async function POST_pushNotification(payload: any) {
  return request.post(`${prefix}/push-notification`, payload);
}

// TODO
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export async function DELETE_cancelMessageToken(payload: any) {
  return request.delete(`${prefix}/cancel-push-notification-token/${payload}`);
}
// TODO
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export async function DELETE_cancelAllMessageToken(payload: any) {
...
// TODO
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export async function POST_androidPushNotification(payload: any) {
  return request.post(`${prefix}/android-push-notification`, payload);
}

// TODO
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export async function POST_iosPushNotification(payload: any) {
  return request.post(`${prefix}/ios-push-notification`, payload);
}

// TODO
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export async function POST_webPushMessage(payload: any) {
