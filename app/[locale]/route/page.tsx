...
import '@/app/[locale]/route/route.scss';
...
export default function RouteTestPage(): React.ReactNode {
  return (
    <section className="route_test_page">
      ...
      <nav className="route_test_page-content" role="navigation">
        {LINK_LIST.map((link) => (
          <Link key={link.to} href={link.to} style={{ textDecoration: 'none' }}>
            <Card className="route_test_page-content-link">
              <CardActionArea>
                <CardContent>
