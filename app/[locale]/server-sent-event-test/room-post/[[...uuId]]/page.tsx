...
export default function SSERoomPostPage(): React.ReactNode {
  ...
  const handleSendMessage = () => {
    ...
    // For POST SSE, reconnect with new message data would be needed
    // This is a simplified demo
    console.log('Sending message:', inputMessage, 'to room:', roomId);
    setInputMessage('');
  };
    ...
    <section>
      ...
      >
        ...
        <Button
          variant="outlined"
          onClick={() =>
            router.push(`/${locale}/server-sent-event-test/room-post`)
          }
        >
          離開房間
        </Button>
