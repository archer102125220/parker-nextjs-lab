...
import '@/app/[locale]/web-cam/web-cam.scss';

export default function WebCamPage(): React.ReactNode {
  ...
  return (
    <section className="web_cam_page">
      ...
      {error && (
        <div className="web_cam_page-error">
